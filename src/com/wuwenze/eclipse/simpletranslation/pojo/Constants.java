...
public interface Constants {
	String KEY_YOUDAO_APP_KEY = "YOUDAO_APP_KEY";
	String KEY_YOUDAO_APP_SECRET = "YOUDAO_APP_SECRET";
	String KEY_OPEN_AUTO_TRANSLATION = "OPEN_AUTO_TRANSLATION";
	String YOUDAO_API_HOST = "http://openapi.youdao.com/api";
